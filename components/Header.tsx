...
import { Palette, DownloadCloud, Box, Film, Database, HardDrive, FileUp, Image as ImageIcon, ChevronDown } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ 
  videoItem, fileName, fileSize, exporting, exportSuccess, onExport, onNewUpload, onSeekFrame, onExtractThumbnail
}) => {
  ...
  // Estimate uncompressed memory usage (approx)
