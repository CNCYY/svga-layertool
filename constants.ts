              ...
              nested: {
                ...
                GradientColor: {
                  fields: {
                    ...
                    b: { type: "float", id: 3 },
                    a: { type: "float", id: 4 },
                    offset: { type: "float", id: 5 },
                  },
                },
                GradientArgs: {
                  fields: {
                    startPoint: { type: "Point", id: 1 },
                    endPoint: { type: "Point", id: 2 },
                    matrix: { type: "Transform", id: 3 },
                    colors: { rule: "repeated", type: "GradientColor", id: 4 },
                  },
                },
                ShapeStyle: {
                  fields: {
                    ...
                    lineDash: { rule: "repeated", type: "float", id: 7 },
                    lineDashOffset: { type: "float", id: 8 },
                    fillGradient: { type: "GradientArgs", id: 10 },
                    strokeGradient: { type: "GradientArgs", id: 11 },
                    trimPathStart: { type: "float", id: 12 },
                    trimPathEnd: { type: "float", id: 13 },
                    trimPathOffset: { type: "float", id: 14 },
                  },
                  nested: {
                    RGBAColor: {
                      fields: {
                    ...
                    LineCap: {
                      values: { LineCap_BUTT: 0, LineCap_ROUND: 1, LineCap_SQUARE: 2 },
                    },
                    LineJoin: {
                      values: { LineJoin_MITER: 0, LineJoin_ROUND: 1, LineJoin_BEVEL: 2 },
                    },
                  },
                },
                ShapeEntity: {
